Shader "Unlit/ScrollingLava"
{
	Properties
	{
		...
		SubShader
		{
			...
			{
				//Scrolling texture shader component, scrolls both textures by a scroll speed * time.
			...
			{
				//Water shader component, displaces the vetices based on a sin wave.
